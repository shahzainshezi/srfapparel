      ...
      <nav className="navbar">
        <div className="nav-container">
          ...
          <div className="nav-actions">
            ...
            {currentUser?.role === 'super_admin' && (
              <Link href="/admin" className="btn btn-glow" style={{ fontSize: '0.8rem', padding: '0.4rem 0.8rem', whiteSpace: 'nowrap' }}>
                <i className='bx bx-shield-quarter'></i> Admin Panel
              </Link>
            )}
            {/* Credits Badge — only when logged in and not super admin */}
            ...
            {/* Cart Icon — only when logged in and not super admin */}
            {currentUser && currentUser.role !== 'super_admin' && (
