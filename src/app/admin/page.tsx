    ...
    <AdminProtectedRoute>
      ...
      <div className="section-container" style={{ padding: '4rem 0', minHeight: '60vh' }}>
        ...
        <div className="admin-grid">
          ...
          {/* Sidebar Menu */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', position: 'sticky', top: '2rem', alignSelf: 'flex-start' }}>
            <button 
                ...
                <div style={{ marginBottom: '1.5rem', display: 'flex', gap: '1rem' }}>
                  <div style={{ position: 'relative', flex: 1 }}>
                    ...
                    <input 
                      ...
                      style={{ width: '100%', padding: '0.8rem 1rem 0.8rem 2.8rem', borderRadius: '10px', border: '1px solid #e2e8f0', outline: 'none', fontSize: '0.95rem' }}
                    />
                  </div>
                  {empSearch && (
                    <button onClick={() => setEmpSearch('')} style={{ background: '#f1f5f9', border: 'none', padding: '0.5rem 1rem', borderRadius: '8px', color: '#64748b', cursor: 'pointer', fontWeight: '600' }}>Clear</button>
                  )}
                </div>
